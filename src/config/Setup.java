...
public class Setup {
	...
	/**
	 * regenerate themes, essentially checking for updates inside
	 * resources/themes.
	 *
	 * @param initialize
	 *            whether to set the current theme to default.
	...
	public static void regenThemes(boolean initialize) {
		...
		if (currentTheme == null) {
			Setup.handleError(new Exception("NO DEFAULT THEME FOUND."));
		}
	}
	 ...
	 * @param c
	 *            the type of element to get the color of.
	 ...
	 *
	 * @return returns a {@code String[]} object containing all the themes, or
	 *         null if it cannot find themes.
	 */
	 ...
	 *
	 * @param themeName
	 *            the name of the theme to be changed to.
