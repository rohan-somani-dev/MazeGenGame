...
=======
  * [Easy Build](#easy-option)
  * [Controlled Option](#controlled-option)
>>>>>>> aaaf8c8eeef07fce07e57ce5e980904222211c6c
...
=======
   ...
   * Player movement, restricted by walls.
   * Path generation with space, using <a href="https://www.geeksforgeeks.org/dsa/greedy-best-first-search-algorithm/">Greedy DFS</a>
   * Theme selection with the arrow keys as well as with the settings icon
   * Full screen display
   * Menu items, Settings and Help
...
The jar will **only run** if resources is in the same folder. Working on a fix. 
>>>>>>> aaaf8c8eeef07fce07e57ce5e980904222211c6c
