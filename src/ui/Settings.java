...
/**
 * A settings dialog with a drop down for themes, path generation, and minor visual changes
 *
 * @author RohanSomani
 * @name Settings
 * @date 2026-01-02
...
public class Settings extends JDialog {
  ...
  private final StyledCheckBox rainbowPath;

  private final StyledCheckBox bestPathGen;
   ...
   * @param settingsClosed the function to call when closed.
   */
  public Settings(Window parent, Runnable requestUpdate, Runnable settingsClosed) {
    ...
    rainbowPath = new StyledCheckBox("Draw Rainbow Path", e -> toggleRainbowPath()
    );
    ...
    bestPathGen = new StyledCheckBox("Use Best Path Generation (slower)", e -> toggleBestPathGen());
