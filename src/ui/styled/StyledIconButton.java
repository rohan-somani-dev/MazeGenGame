...
/**
 * A pretty clickable button with a label as its icon
 *
 * @author RohanSomani
 * @name Button
 * @date 2026-01-02
...
public class StyledIconButton extends JButton implements Renderable {
   ...
   * @param visualType the color for the icon to be.
   */
  public StyledIconButton(ImageIcon icon, VisualType visualType) {
    super(icon);
